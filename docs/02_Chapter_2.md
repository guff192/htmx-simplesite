...
Once you are comfortable with Jinja templates and the way you can use Tailwind, you should be ready to move on to [Chapter 3](https://github.com/guff192/htmx-simplesite/blob/main/docs/03_Chapter_3.md).
